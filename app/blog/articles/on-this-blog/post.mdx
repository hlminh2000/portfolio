...
Popping that into Claude, I got something like so:

<Image
  src={claude_gen_original}
  className='rounded-lg drop-shadow-lg'
/>

This was rather basic and not what I was looking for, so I thought the prompt could be better. 
