...
preview: I decided to finally create a portfolio blog, and it was done in 2 days thanks to AI.
...
unique product** where I can continuously build and experiment on, **a space where I can share my journey** 
...
friends, and the page you're on **was put together in under a day** (minus the writing of blog posts - I write
these myself).
...
## 3. v0.dev for initial setup

If you haven't already, you should totally **check out [v0.dev](https://v0.dev)**. I learned about it from
...
code that Claude gave me into v0.dev, with the following prompt:
...
The **basic setup for my site was done** ready, even comes **with dynamic routing for the blog posts**:
...
Claude and v0.dev have probably together **saved me a few days** compared to if I was to design and setup
everything myself.
...
project and beyond. Keep aand eye out for more to come.